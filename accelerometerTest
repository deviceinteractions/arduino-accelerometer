...
// Initializing a variable name accelerometer of type MPU6050

void setup(){

  Serial.begin(115200);
  // Starting the serial communication at 115200 baud rate.
  ...
  // Checking connection to the mpu6050 sensor
  {
...
void loop(){
  ...
  // Printing the pitch values on the Serial Monitor
  ...
  // printing the Roll values on the serial monitor
